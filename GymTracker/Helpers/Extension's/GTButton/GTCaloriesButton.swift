...
public enum GTCaloriesButtonType {
    case caloriesControllerButton
    case calculate
    case resultButton
}

final class GTCaloriesButton : UIButton {
    
    //MARK: - PROPERTIES
    private var type: GTCaloriesButtonType = .caloriesControllerButton
    
    private let label = UILabel()
    private let iconView = UIImageView ()
    
    //MARK: - LIFECYCLE
    init(with type: GTCaloriesButtonType) {
...
// MARK: - EXTENSION
private extension GTCaloriesButton {
    ...
    func constaintViews() {
        ...
        case .caloriesControllerButton :
            ...
            iconView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 40).isActive = true
