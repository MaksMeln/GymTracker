...
final class StartRoutineTitleView : GTBaseView {
...
private let volumeSubtitleLabel = GTLabel(text: "0",
...
private let setsSubtitleLabel = GTLabel(text: "0" + ResStartWorkout.String.Labels.kg,
                                    font: Resourses.Fonts.helveticaRegular(with: 16),
                                    textColor: Resourses.Colors.defaultColor)
