...
class ExerciseController: GTBaseController {
...
extension ExerciseController: UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.imageExercise.image = exercise.exerciseImageInfo
        vc.title = exercise.exerciseTitle
        vc.instructionTextView.text = exercise.exerciseTextInfo
