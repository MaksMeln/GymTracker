...
class StartRoutineController : GTBaseController {
...
private let volumeSubtitleLabel = UILabel(text: "0" + ResStartWorkout.String.Labels.kg,
...
private let setsSubtitleLabel = UILabel(text: "0",
                                    font: Resourses.Fonts.helveticaRegular(with: 16),
                                    textColor: Resourses.Colors.defaultColor)
